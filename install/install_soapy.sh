#!/bin/bash
#
#   Install SoapySDR on an Ubuntu 16.04 or later machine. Use -h for more details.
#
...
sudo apt update
sudo apt-get install -y software-properties-common python3-software-properties python-software-properties git python3 python-numpy python3-numpy cmake swig python-dev build-essential libqt4-dev swig sip-dev python3-dev # libqt5-dev
